...
if (document.getElementById && document.childNodes && document.createElement) {
    ...
    if (!MathJax.Hub) {
        ...
        (function (d) {
            ...
            b.Object = c({
                constructor: a(), Subclass: function (g, i) {
                    var h = a();
                    h.SUPER = this;
                    h.Init = this.Init;
            ...
            a.Ajax = {
                ...
                loader: {
                    JS: function (i, k) {
                        ...
                        i.type = "text/css";
                        i.href = h;
                        this.loading[h] = {callback: j, message: a.Message.File(h), status: this.STATUS.OK};
        ...
        (function (d) {
            ...
            }, {id: "Jax", version: "2.2", directory: e + "/jax", extensionDir: e + "/extensions"});
            ...
            }, {id: "InputJax", version: "2.2", directory: g.directory + "/input", extensionDir: g.extensionDir});
            ...
            b.OutputJax.Error = {
                id: "Error", version: "2.2", config: {}, ContextMenu: function () {
